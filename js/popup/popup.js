...
stc.util.popup = function(current) {
  ...
  try { 
        ...
        stc.util.addScript("/stc-ui/dist/js/stc-ui.min.js", function() {
            ...
            window.addEventListener('countryIsSet', function() {
                ...
                if(current !== stc.geo.country && stc.geo.memberCountry) {
                    console.log('display popup from ' + current + ' to ' + stc.geo.memberCountry.iso);
                    //dynamically load css.
                    stc.util.addCSS("/stc-ui/dist/css/stc-ui.min.css", function() {
